...
import com.backend.smartmart.entity.JwtRequest;
import com.backend.smartmart.entity.JwtResponse;
...
public class JwtService implements UserDetailsService {
    ...
    // Method to load the user by username
    @Override
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        User user = userDao.findById(username).orElseThrow(() -> new UsernameNotFoundException("Username not found"));
